 ...
 *
 * The VK.ru authentication strategy authenticates requests by delegating to
 * VK.ru using the OAuth 2.0 protocol.
 *
 ...
 *
 * Options:
 *   - `clientID`      your VK.ru application's App ID
 *   - `clientSecret`  your VK.ru application's App Secret
 *   - `callbackURL`   URL to which VK.ru will redirect the user after granting authorization
 *   - `profileFields` array of fields to retrieve from VK.ru
...
function Strategy(options, verify) {
  ...
  options.authorizationURL =
    options.authorizationURL || "https://oauth.vk.ru/authorize";
 ...
 * token exchange. See https://new.vk.ru/dev/auth_sites
 *
